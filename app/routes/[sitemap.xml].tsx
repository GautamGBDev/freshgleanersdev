...
function generateSitemap({
  ...
  let webAppFlowPages = [
    ...
    '/account/profile/pickup',
    '/account/profile/basket',
    '/account/orders',
    '/account/profile/confirm-order',
    '/account/profile/order-review',
    '/policies/privacy-policy',
  ];

  const webAppPage = webAppFlowPages.map((page) => {
  ...
  const urls = [...products, ...collections, ...pages, ...webAppPage];
